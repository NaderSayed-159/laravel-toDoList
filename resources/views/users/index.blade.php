    ...
    <div class="container">
        ...
        <table class='m-5 table table-hover table-responsive table-bordered'>
            ...
            @foreach ($data as $fetchedData)
                ...
                <div class="modal" id="modal_single_task{{ $fetchedData->id }}" tabindex="-1" role="dialog">
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title">Users Tasks</h5>
                            ...
                            <div class="modal-body">
                                <p> {{ Str::of($fetchedData->name)->upper() }} Tasks</p>
                                <div>
                                    @foreach ($fetchedData->histasks as $tasks)
                                        {{ $tasks->title }} <br>
                                    @endforeach
                                </div>
                            </div>
